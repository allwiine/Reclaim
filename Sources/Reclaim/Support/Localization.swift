...
/// A pure bundle read, so it stays callable from off-main contexts
/// rather than inheriting the module's MainActor default.
...
nonisolated enum LocalizationResources {
